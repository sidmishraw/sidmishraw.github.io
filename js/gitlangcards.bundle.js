(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		module.exports = factory(require("jquery"), require("react"), require("react-dom"), require("materialize-css"));
	else if(typeof define === 'function' && define.amd)
		define("gitlangcards", ["jquery", "react", "react-dom", "materialize-css"], factory);
	else if(typeof exports === 'object')
		exports["gitlangcards"] = factory(require("jquery"), require("react"), require("react-dom"), require("materialize-css"));
	else
		root["gitlangcards"] = factory(root["jQuery"], root["React"], root["ReactDOM"], root["materialize"]);
})(this, function(__WEBPACK_EXTERNAL_MODULE_18__, __WEBPACK_EXTERNAL_MODULE_20__, __WEBPACK_EXTERNAL_MODULE_21__, __WEBPACK_EXTERNAL_MODULE_22__) {
...
exports.GitHubLanguageColors = undefined;

var _gitlangcards = __webpack_require__(17);
...
//# imports ES6
var GitHubLanguageColors = exports.GitHubLanguageColors = _gitlangcards.GitHubLangColors;
...
exports.GitHubLangColors = undefined;
...
var _gitlangcolors = __webpack_require__(19);
 ...
 */
var GitLangCard = function (_Component) {
  _inherits(GitLangCard, _Component);

  //# constructor
  function GitLangCard(props) {
    _classCallCheck(this, GitLangCard);

    var _this = _possibleConstructorReturn(this, (GitLangCard.__proto__ || Object.getPrototypeOf(GitLangCard)).call(this, props));

    _this.langColor = _this.__getMyLangColor(_this.props.language);
    return _this;
  }
  //# constructor
  ...
  _createClass(GitLangCard, [{
    key: "__getMyLangColor",
    value: function __getMyLangColor(language) {
      return _gitlangcolors.GITHUB_LANG_COLORS[language]["color"];
    }
    ...
    value: function render() {
      return _react2.default.createElement(
        "div",
        { className: "carousel-item col s12 m7", style: { width: "24%" } },
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            ...
            _react2.default.createElement("span", { className: "left-color-img", style: { backgroundColor: this.langColor } })
          ),
          _react2.default.createElement(
            "div",
            ...
            _react2.default.createElement(
              ...
              _react2.default.createElement(
                "a",
                { style: { color: "dark-orange" }, href: this.props.projectsURL },
...
var GitLangCards = function (_Component2) {
  _inherits(GitLangCards, _Component2);

  //# constructor
  function GitLangCards(props) {
    _classCallCheck(this, GitLangCards);

    //# state, list of GitLangCard components
    var _this2 = _possibleConstructorReturn(this, (GitLangCards.__proto__ || Object.getPrototypeOf(GitLangCards)).call(this, props));

    _this2.state = {
      languageCards: []
    };
    //# state, list of GitLangCard components
    _this2.__fetchGitHubLangs(_this2.props.username);
    return _this2;
  }
  //# constructor
  ...
  _createClass(GitLangCards, [{
    key: "__fetchGitHubLangs",
    value: function __fetchGitHubLangs(username) {
      if (!username) {
      ...
      jQuery.ajax({
        ...
        success: function success(res) {
          if ((typeof res === "undefined" ? "undefined" : _typeof(res)) === "object") {
            // console.log(res);
            var languages = component.__myLanguages(username, res);
    ...
    key: "__generateCards",
    value: function __generateCards(languages) {
      var langCards = [];
      Object.keys(languages).forEach(function (lang) {
        // console.log(lang);
        langCards.push(_react2.default.createElement(GitLangCard, { key: lang, language: lang, projectsURL: languages[lang] }));
      });
      return langCards;
    }
    ...
    key: "__myLanguages",
    value: function __myLanguages(username, projects) {
      var languagesString = "";
      var langs = {};
      projects.map(function (prj) {
        if (prj["language"] && prj["language"] !== "null") {
          langs[prj["language"]] = "https://github.com/" + username + "?utf8=%E2%9C%93&tab=repositories&q=&type=&language=" + encodeURIComponent(prj["language"]);
        }
      });
      return langs;
    }
...
var GitHubLangColors = exports.GitHubLangColors = function () {
  function GitHubLangColors() {
    _classCallCheck(this, GitHubLangColors);
  }

  _createClass(GitHubLangColors, [{
    key: "renderOnScreen",
     ...
     */
    value: function renderOnScreen(userName, elementId, callback) {
      (0, _reactDom.render)(_react2.default.createElement(GitLangCards, { username: userName, callback: callback }), jQuery("#" + elementId).get(0));
    }
  }]);

  return GitHubLangColors;
}();
 ...
 */
var GITHUB_LANG_COLORS = exports.GITHUB_LANG_COLORS = {
  "1C Enterprise": {
    color: "#814CCC",
